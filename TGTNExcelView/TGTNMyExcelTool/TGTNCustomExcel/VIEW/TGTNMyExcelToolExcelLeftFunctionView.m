//
//  TGTNMyExcelToolExcelLeftFunctionView.m
//  TGTNExcelView
//
...
@interface TGTNMyExcelToolExcelLeftFunctionView()
/// 按钮
@property (nonatomic, strong) UIButton *functionButton;
@end

@implementation TGTNMyExcelToolExcelLeftFunctionView
...
- (void)functionButtonClick:(UIButton *) button {
    TGTNMyExcelToolExcelLeftFunctionModel *leftFunctionModel = (TGTNMyExcelToolExcelLeftFunctionModel *)self.model;
    if (leftFunctionModel.buttonClickConfig) {
        leftFunctionModel.buttonClickConfig(leftFunctionModel.selectIndexPath);
    }
}
